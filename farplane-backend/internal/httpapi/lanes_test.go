...
func (f *fakeRuntime) EnsureAgentBridge(ctx context.Context, id string) error { _, _ = ctx, id; return nil }
...
func (f *fakeRuntime) BuildImage(ctx context.Context, dockerfileText string, tag string) (string, string, error) {
