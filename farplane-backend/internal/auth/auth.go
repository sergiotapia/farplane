...
func ParseOAuthState(secret, encoded string, now time.Time) (OAuthState, error) { //nolint:gocyclo // multi-branch orchestration; keep under threshold when rewriting
